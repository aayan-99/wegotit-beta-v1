...
const TypeFacePage = () => {
  ...
  return (
    <div className='w-full bg-black pb-[150px]'>
      ...
      <div className="w-[60%] mx-auto flex lg:flex-row flex-col gap-6">
        <div className="w-full lg:w-[50%] gap-5 p-14 pb-16 px-20 border-2 border-white rounded-[25px] flex flex-col justify-start">
